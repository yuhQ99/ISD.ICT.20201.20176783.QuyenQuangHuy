...
public class Configs {
	...
	public static final String RUSH_ORDER_SCREEN_PATH = "/views/fxml/rush_order_info.fxml";
	public static final String INVOICE_RUSH_ORDER_PATH = "/views/fxml/rush_order_invoice.fxml";
